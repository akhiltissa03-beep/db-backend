...
const { signup, signin, adminsignin, add_terms, get_terms, get_terms_by_id, search_agreement, changePassword, getTodaysRegistrations, populateDatabase } = require('../controller/home.controller');
...
router.post("/updateCallerNames", updateCallerNames);
...
// delete agreement
router.post("/deleteAgreement/:id", deleteAgreement)
